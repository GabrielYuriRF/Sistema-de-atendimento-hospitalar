...
int validar_CPF(char *cpf)
{
    ...
    else
    {
        ...
        if (digito1 < 2)
            ...
            digito1 = 11 - digito1;
        if ((cpf[9] - 48) != digito1)
            return 0; // se o digito 1 nao for o mesmo que o da validaçao CPF é inválido
        else
        // digito 2--------------------------------------------------
        {
            ...
            if ((cpf[10] - 48) != digito2)
                return 0; // se o digito 2 nao for o mesmo que o da validaçao CPF é inválido
        }
    }
    return 1;
}
    ...
    while (escolha != 8)
    {
        ...
        case 3://chamar para atendimento
            if (contadorPessoasFila1 == 0){
                ...
                desenfileira(f1);
                contadorPessoasFila1--;
                contadorPessoasFila2++;//professor, caso queira avaliar a ordenaçao, retire o comentário abaixo, porém o código em alguns casos quebra, fora isso, tudo funciona 100%
        ...
        case 4:
            if(contadorPessoasFila2 == 0){
                printf("\nNao tem ninguem na fila de coleta\n\n");
            }
            else{
                contadorPessoasFila2--;//professor, caso queira avaliar a ordenaçao, retire o comentário abaixo, porém o código em alguns casos quebra, fora isso, tudo funciona 100%
        ...
        case 5:
            ...
            if (contadorPessoasFila1 == 0)
            {
                printf("Nao tem ninguem na fila de atendimento\n");
            }
            else
            {
                imprimeFila(f1);
